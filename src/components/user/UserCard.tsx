    ...
    return(
        ...
        style={props.user.Active ? {opacity: "100%"} : {opacity: "30%"}}>            
            <img className='UserImage' src={
                props.user.Id ?
                `http://192.168.15.144:60000/user/get-image?userId=${props.user.Id}` : 
                `http://192.168.15.144:60000/user/get-new-image`
                }/>
            ...
            
            {
                ...
                {props.user.LastPaymante && <h4>Ultimo pagamento: <code>{props.user.LastPaymante.toDateString()}</code></h4>}
